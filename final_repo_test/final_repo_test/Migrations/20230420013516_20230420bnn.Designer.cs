...
namespace final_repo_test.Migrations
{
    ...
    [Migration("20230420013516_20230420bnn")]
            ...
            modelBuilder.Entity("final_repo_test.Models.DebugLog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            D_event = "test",
                            D_isSolved = true,
                            D_time = new DateTime(2023, 4, 20, 9, 35, 16, 433, DateTimeKind.Local).AddTicks(2218)
                        },
                        new
                        {
                            D_ID = 2,
                            ...
                            D_event = "test",
                            D_isSolved = true,
                            D_time = new DateTime(2023, 4, 20, 9, 35, 16, 433, DateTimeKind.Local).AddTicks(2229)
                        },
                        new
                        {
                            D_ID = 3,
            ...
            modelBuilder.Entity("final_repo_test.Models.LoginStaus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            L_ID = 1,
                            A_ID = 1,
                            L_cTime = new DateTime(2023, 4, 20, 9, 35, 16, 433, DateTimeKind.Local).AddTicks(3261),
                            L_dcTime = new DateTime(2023, 4, 20, 10, 35, 16, 433, DateTimeKind.Local).AddTicks(3262)
                        },
                        new
                        {
                            L_ID = 2,
                            A_ID = 1,
                            L_cTime = new DateTime(2023, 4, 19, 7, 35, 16, 433, DateTimeKind.Local).AddTicks(3267),
                            L_dcTime = new DateTime(2023, 4, 19, 8, 35, 16, 433, DateTimeKind.Local).AddTicks(3267)
                        },
                        new
                        {
                            L_ID = 3,
                            A_ID = 1,
                            L_cTime = new DateTime(2023, 4, 18, 6, 35, 16, 433, DateTimeKind.Local).AddTicks(3268),
                            L_dcTime = new DateTime(2023, 4, 18, 7, 35, 16, 433, DateTimeKind.Local).AddTicks(3269)
                        },
                        new
                        {
                            L_ID = 4,
                            A_ID = 1,
                            L_cTime = new DateTime(2023, 4, 17, 5, 35, 16, 433, DateTimeKind.Local).AddTicks(3270),
                            L_dcTime = new DateTime(2023, 4, 17, 6, 35, 16, 433, DateTimeKind.Local).AddTicks(3270)
                        },
                        new
                        {
                            L_ID = 5,
                            A_ID = 1,
                            L_cTime = new DateTime(2023, 4, 16, 4, 35, 16, 433, DateTimeKind.Local).AddTicks(3271),
                            L_dcTime = new DateTime(2023, 4, 16, 5, 35, 16, 433, DateTimeKind.Local).AddTicks(3271)
                        },
                        new
                        {
                            L_ID = 6,
                            A_ID = 1,
                            L_cTime = new DateTime(2023, 4, 16, 3, 35, 16, 433, DateTimeKind.Local).AddTicks(3272),
                            L_dcTime = new DateTime(2023, 4, 16, 4, 35, 16, 433, DateTimeKind.Local).AddTicks(3272)
                        },
                        new
                        {
                            L_ID = 7,
                            A_ID = 1,
                            L_cTime = new DateTime(2023, 4, 16, 2, 35, 16, 433, DateTimeKind.Local).AddTicks(3273),
                            L_dcTime = new DateTime(2023, 4, 16, 3, 35, 16, 433, DateTimeKind.Local).AddTicks(3274)
                        });
                });
            ...
            modelBuilder.Entity("final_repo_test.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            P_ID = 1,
                            P_Date = new DateTime(2023, 4, 20, 9, 35, 16, 434, DateTimeKind.Local).AddTicks(2604),
                        ...
                        {
                            P_ID = 2,
                            P_Date = new DateTime(2023, 4, 20, 9, 35, 16, 434, DateTimeKind.Local).AddTicks(2608),
            ...
            modelBuilder.Entity("final_repo_test.Models.UserAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            A_NickName = "Test",
                            A_Phone = "0900000000",
                            A_RegisteredAt = new DateTime(2023, 4, 20, 9, 35, 16, 434, DateTimeKind.Local).AddTicks(2625),
                            A_add = "Test",
                            A_level = 99,
                            Birthday = new DateTime(2023, 4, 20, 9, 35, 16, 434, DateTimeKind.Local).AddTicks(2624),
                            P_id = 1,
                            UserName = "Test",
                            UserPWD = "Test"
                        });
