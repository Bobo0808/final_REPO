    ...
    public partial class bnn : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 4, 18, 16, 19, 6, 405, DateTimeKind.Local).AddTicks(9237), "Regular Fit反摺袖襯衫", false, 0, "1.jpg", 99, "反摺袖襯衫", 699, 1 },
                    { 2, new DateTime(2023, 4, 18, 16, 19, 6, 405, DateTimeKind.Local).AddTicks(9242), "Regular Fit棉麻短袖襯衫", false, 0, "2.jpg", 99, "短袖襯衫", 499, 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 999999, "Test@gmail.com", 0, "Test", "Test", "0900000000", new DateTime(2023, 4, 18, 16, 19, 6, 405, DateTimeKind.Local).AddTicks(9258), "Test", 99, new DateTime(2023, 4, 18, 16, 19, 6, 405, DateTimeKind.Local).AddTicks(9257), 1, "Test", "Test" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 4, 18, 16, 19, 6, 405, DateTimeKind.Local).AddTicks(20), new DateTime(2023, 4, 18, 17, 19, 6, 405, DateTimeKind.Local).AddTicks(35) },
                    { 2, 1, new DateTime(2023, 4, 17, 14, 19, 6, 405, DateTimeKind.Local).AddTicks(39), new DateTime(2023, 4, 17, 15, 19, 6, 405, DateTimeKind.Local).AddTicks(40) },
                    { 3, 1, new DateTime(2023, 4, 16, 13, 19, 6, 405, DateTimeKind.Local).AddTicks(41), new DateTime(2023, 4, 16, 14, 19, 6, 405, DateTimeKind.Local).AddTicks(41) },
                    { 4, 1, new DateTime(2023, 4, 15, 12, 19, 6, 405, DateTimeKind.Local).AddTicks(42), new DateTime(2023, 4, 15, 13, 19, 6, 405, DateTimeKind.Local).AddTicks(42) },
                    { 5, 1, new DateTime(2023, 4, 14, 11, 19, 6, 405, DateTimeKind.Local).AddTicks(43), new DateTime(2023, 4, 14, 12, 19, 6, 405, DateTimeKind.Local).AddTicks(43) },
                    { 6, 1, new DateTime(2023, 4, 14, 10, 19, 6, 405, DateTimeKind.Local).AddTicks(44), new DateTime(2023, 4, 14, 11, 19, 6, 405, DateTimeKind.Local).AddTicks(44) },
                    { 7, 1, new DateTime(2023, 4, 14, 9, 19, 6, 405, DateTimeKind.Local).AddTicks(45), new DateTime(2023, 4, 14, 10, 19, 6, 405, DateTimeKind.Local).AddTicks(46) }
                });
