    ...
    public partial class m1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 4, 18, 20, 25, 6, 938, DateTimeKind.Local).AddTicks(1747), "Regular Fit反摺袖襯衫", false, 0, "1.jpg", 99, "反摺袖襯衫", 699, 1 },
                    { 2, new DateTime(2023, 4, 18, 20, 25, 6, 938, DateTimeKind.Local).AddTicks(1757), "Regular Fit棉麻短袖襯衫", false, 0, "2.jpg", 99, "短袖襯衫", 499, 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 999999, "Test@gmail.com", 0, "Test", "Test", "0900000000", new DateTime(2023, 4, 18, 20, 25, 6, 938, DateTimeKind.Local).AddTicks(1783), "Test", 99, new DateTime(2023, 4, 18, 20, 25, 6, 938, DateTimeKind.Local).AddTicks(1781), 1, "Test", "Test" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 4, 18, 20, 25, 6, 934, DateTimeKind.Local).AddTicks(6842), new DateTime(2023, 4, 18, 21, 25, 6, 934, DateTimeKind.Local).AddTicks(6853) },
                    { 2, 1, new DateTime(2023, 4, 17, 18, 25, 6, 934, DateTimeKind.Local).AddTicks(6864), new DateTime(2023, 4, 17, 19, 25, 6, 934, DateTimeKind.Local).AddTicks(6865) },
                    { 3, 1, new DateTime(2023, 4, 16, 17, 25, 6, 934, DateTimeKind.Local).AddTicks(6866), new DateTime(2023, 4, 16, 18, 25, 6, 934, DateTimeKind.Local).AddTicks(6867) },
                    { 4, 1, new DateTime(2023, 4, 15, 16, 25, 6, 934, DateTimeKind.Local).AddTicks(6868), new DateTime(2023, 4, 15, 17, 25, 6, 934, DateTimeKind.Local).AddTicks(6869) },
                    { 5, 1, new DateTime(2023, 4, 14, 15, 25, 6, 934, DateTimeKind.Local).AddTicks(6870), new DateTime(2023, 4, 14, 16, 25, 6, 934, DateTimeKind.Local).AddTicks(6870) },
                    { 6, 1, new DateTime(2023, 4, 14, 14, 25, 6, 934, DateTimeKind.Local).AddTicks(6872), new DateTime(2023, 4, 14, 15, 25, 6, 934, DateTimeKind.Local).AddTicks(6872) },
                    { 7, 1, new DateTime(2023, 4, 14, 13, 25, 6, 934, DateTimeKind.Local).AddTicks(6873), new DateTime(2023, 4, 14, 14, 25, 6, 934, DateTimeKind.Local).AddTicks(6874) }
                });
